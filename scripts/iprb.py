...
def iprb(file_name):
    """
    Prints the probability that two randomly selected mating organisms will
    ...
    balls. If we let X represent the random variable corresponding to the color
    of a drawn ball, then the probability of each of the two outcomes is given
    by Pr(X=red)=35 and Pr(X=blue)=25.
    ...
    the path from the beginning of the tree.
